    ...
    return (
        <>
            <Navigation bg={bg}
                info={true}
                buttonShow={false}
                heading={'SWEET SYMPHONY'}
                infoline={'BY ELISE CARSTAIR . FEB 27, 2022 . NEWS'} />
                ...
                <Row className="">
                    ...
                    <Col className="px-8">
                        ...
                        <div className="font-serif font-medium mb-8 text-lg">
                            Dive into a world of sweetness and sophistication as our dessert haven unveils a mesmerizing
                            array of confectionery wonders. From delectable cakes to exquisite pastries, we bring you an
                            experience that transcends the ordinary and celebrates the extraordinary.
                        </div>
                        <div className="font-serif font-medium mb-8 text-lg">
                            In the heart of our dessert sanctuary, each creation is a masterpiece, meticulously crafted
                            to ignite your taste buds and elevate your senses. Our culinary artisans have spared no effort
                            in curating a menu that promises to transport you to a realm of flavors that dance harmoniously
                            on your palate.
                        </div>
                        <img src={cafe} alt="" className="mb-12" />

                        <div className="font-serif font-medium mb-8 text-2xl">
                            INDULGE IN THE SWEETEST SYMPHONY OF FLAVORS, WHERE EACH NOTE IS A TASTE BUD SERENADE, AND
                            EVERY BITE IS A STANDING OVATION FOR YOUR SENSES.
                        </div>
                        <div className="font-serif font-medium mb-8 text-lg">
                            Our commitment to excellence extends beyond taste to the aesthetics of our desserts. Immerse
                            yourself in an ambiance of sophistication and elegance, where every detail is curated to enhance
                            your overall dining experience. From the chic decor to the attentive service, we leave no stone
                            unturned in creating a haven that is as visually appealing as it is delicious.
                        </div>
                        ...
                        <Link to="/news/velvet-truffle" path="relative">
                            <div className="mb-10">
