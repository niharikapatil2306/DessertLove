    ...
    return (
        <>
            <Navigation bg={bg}
                info={true}
                buttonShow={false}
                heading={'BREWED EUPHORIA'}
                infoline={'BY ELISE CARSTAIR . MARCH 14, 2023 . NEWS'} />

            <Container fluid className="bg-pink-100 py-20 g-0 text-justify px-4 md:px-12">
                <Row>
                    <Col lg={4} className="px-10">
                    ...
                    <Col className="px-8">
                        ...
                        <div className="font-serif font-medium mb-8 text-lg">
                            Introducing the latest addition to our liquid symphony – "Brewed Euphoria." Immerse yourself in a world
                            of delight as rich, velvety coffee meets the indulgent swirl of caramel, creating a harmonious dance of
                            flavors that transcends the ordinary. Served over a cascade of ice, this drink is a celebration of the
                            perfect union between robust coffee notes and the sweet embrace of caramel.
                        </div>
                        <div className="font-serif font-medium mb-8 text-lg">
                            At our beverage sanctuary, we believe in crafting experiences that awaken the senses. Brewed Euphoria
                            is not just a drink; it's a symphony in a glass. The marriage of coffee's bold complexity and the silky
                            sweetness of caramel creates a beverage that is both invigorating and indulgent, inviting you to savor
                            the melody with every refreshing sip.
                        </div>
                        <img src={coffee} alt="" className="mb-12" />

                        <div className="font-serif font-medium mb-8 text-2xl">
                            SIP INTO PURE BLISS WITH BREWED EUPHORIA, WHERE THE BOLD RHYTHM OF COFFEE MEETS THE SWEET MELODY OF
                            CARAMEL FOR A LIQUID SYMPHONY THAT ECHOES WITH EVERY DELIGHTFUL SIP.
                        </div>
                        <div className="font-serif font-medium mb-8 text-lg">
                            At our beverage sanctuary, we believe in crafting experiences that awaken the senses. Brewed Euphoria
                            is not just a drink; it's a symphony in a glass. The marriage of coffee's bold complexity and the silky
